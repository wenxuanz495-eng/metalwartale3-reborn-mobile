package ctrl4399.proxy.unionApi
{
   ...
   public class Err extends Error implements TBase
   {
      
      private static const STRUCT_DESC:TStruct = new TStruct("Err");
      ...
      FieldMetaData.addStructMetaDataMap(Err,metaDataMap);
      ...
      {
         var _loc1_:String = new String("Err(");

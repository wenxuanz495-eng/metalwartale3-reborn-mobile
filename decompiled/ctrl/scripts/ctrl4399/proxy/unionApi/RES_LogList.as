package ctrl4399.proxy.unionApi
{
   ...
   public class RES_LogList implements TBase
   {
      
      private static const STRUCT_DESC:TStruct = new TStruct("RES_LogList");
      
      private static const TAG_FIELD_DESC:TField = new TField("tag",TType.STRING,1);
      
      private static const LOG_LIST_FIELD_DESC:TField = new TField("logList",TType.LIST,2);
      
      private static const COUNT_FIELD_DESC:TField = new TField("count",TType.STRING,3);
      
      public static const TAG:int = 1;
      
      public static const LOGLIST:int = 2;
      ...
      metaDataMap[LOGLIST] = new FieldMetaData("logList",TFieldRequirementType.DEFAULT,new ListMetaData(TType.LIST,new FieldValueMetaData(TType.STRING)));
      metaDataMap[COUNT] = new FieldMetaData("count",TFieldRequirementType.DEFAULT,new FieldValueMetaData(TType.STRING));
      FieldMetaData.addStructMetaDataMap(RES_LogList,metaDataMap);
      ...
      public function set logList(param1:Array) : void
      {
         this._logList = param1;
      }
      
      public function unsetLogList() : void
      {
         this.logList = null;
      }
      
      public function isSetLogList() : Boolean
      {
      ...
      public function write(param1:TProtocol) : void
      {
         ...
         {
            param1.writeFieldBegin(LOG_LIST_FIELD_DESC);
            param1.writeListBegin(new TList(TType.STRING,this.logList.length));
            for each(_loc2_ in this.logList)
            {
               param1.writeString(_loc2_);
            }
            param1.writeListEnd();
            param1.writeFieldEnd();
         }
      ...
      {
         var _loc1_:String = new String("RES_LogList(");

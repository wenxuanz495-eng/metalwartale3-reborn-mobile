package ctrl4399.proxy.unionApi
{
   ...
   public class UnionBool implements TBase
   {
      
      private static const STRUCT_DESC:TStruct = new TStruct("UnionBool");
      
      private static const TAG_FIELD_DESC:TField = new TField("tag",TType.STRING,1);
      
      private static const RESULT_FIELD_DESC:TField = new TField("result",TType.BOOL,2);
      ...
      metaDataMap[RESULT] = new FieldMetaData("result",TFieldRequirementType.REQUIRED,new FieldValueMetaData(TType.BOOL));
      FieldMetaData.addStructMetaDataMap(UnionBool,metaDataMap);
      ...
      {
         var _loc1_:String = new String("UnionBool(");

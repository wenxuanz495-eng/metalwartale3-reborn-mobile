package ctrl4399.proxy.shopApi
{
   ...
   public class Err_Store extends Error implements TBase
   {
      
      private static const STRUCT_DESC:TStruct = new TStruct("Err_Store");
      ...
      FieldMetaData.addStructMetaDataMap(Err_Store,metaDataMap);
      ...
      {
         var _loc1_:String = new String("Err_Store(");

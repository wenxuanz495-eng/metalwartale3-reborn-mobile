package ctrl4399.proxy.rankListApi
{
   ...
   public class FSR_GetRank implements TBase
   {
      
      private static const STRUCT_DESC:TStruct = new TStruct("FSR_GetRank");
      ...
      FieldMetaData.addStructMetaDataMap(FSR_GetRank,metaDataMap);
      ...
      {
         var _loc1_:String = new String("FSR_GetRank(");

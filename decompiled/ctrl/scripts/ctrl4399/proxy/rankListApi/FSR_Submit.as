package ctrl4399.proxy.rankListApi
{
   ...
   public class FSR_Submit implements TBase
   {
      
      private static const STRUCT_DESC:TStruct = new TStruct("FSR_Submit");
      ...
      metaDataMap[DATA] = new FieldMetaData("data",TFieldRequirementType.DEFAULT,new StructMetaData(TType.STRUCT,FSRE_Submit));
      FieldMetaData.addStructMetaDataMap(FSR_Submit,metaDataMap);
      
      private var _code:int;
      
      private var _message:String;
      
      private var _data:FSRE_Submit;
      
      private var __isset_code:Boolean = false;
      
      public function FSR_Submit()
      {
         super();
      }
      ...
      public function get data() : FSRE_Submit
      {
         return this._data;
      }
      
      public function set data(param1:FSRE_Submit) : void
      {
         this._data = param1;
      }
      ...
      {
         var _loc1_:String = new String("FSR_Submit(");

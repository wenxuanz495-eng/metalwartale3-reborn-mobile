package ctrl4399.proxy.rankListApi
{
   ...
   public class FSR_GetRanking implements TBase
   {
      
      private static const STRUCT_DESC:TStruct = new TStruct("FSR_GetRanking");
      ...
      metaDataMap[DATA] = new FieldMetaData("data",TFieldRequirementType.DEFAULT,new ListMetaData(TType.LIST,new StructMetaData(TType.STRUCT,FSRE_RankingItem)));
      FieldMetaData.addStructMetaDataMap(FSR_GetRanking,metaDataMap);
      ...
      public function FSR_GetRanking()
      {
         super();
      }
      ...
      public function read(param1:TProtocol) : void
      {
         ...
         var _loc4_:int = 0;
         var _loc5_:FSRE_RankingItem = null;
      ...
      {
         var _loc1_:String = new String("FSR_GetRanking(");

package gameAll.define
{
   ...
   public class ArenaFlipCardDefine
   {
      ...
      public var armsArr:Array = ["sub,positron_lv1","arms,snow_lv1"];
      
      public var type_arr:Array = ["exp","coin","coin1","coin2","exp3"];
      
      public var pro_arr:Array = [0.5,0.5,0,0,0];
      
      public var number10w:String = TextWay.toCode("100000");
      ...
      public function getGoodsDefineStr_byType(param1:String, param2:int) : String
      {
         ...
         if(param1.indexOf("exp") >= 0)
         {
            if(param2 > this.exp_arr.length - 1)
            {
               param2 = this.exp_arr.length - 1;
            }
            _loc3_ = "exp," + TextWay.getText(this.number10w) + ",1";
         }
         else if(param1.indexOf("coin") >= 0)
         {
            if(param2 > this.coin_arr.length - 1)
            {
               param2 = this.coin_arr.length - 1;
            }
            _loc3_ = "GCoin," + TextWay.getText(this.number10w) + ",1";
         }

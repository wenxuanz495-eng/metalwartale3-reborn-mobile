package enemy.spiderFort
{
   ...
   public class SpiderFortBody
   {
      ...
      public var animation:SpiderFortAnimation;
      
      public var AAHD:ChargerAAHD;
      
      public var ai:SpiderFort_AI;
      ...
      public function SpiderFortBody()
      {
         super();
         this.animation = new SpiderFortAnimation(this.img,this.mot);
         this.AAHD = new ChargerAAHD(this,this.img,this.armsDefine,this.define);
         this.ai = new SpiderFort_AI(this);

package enemy.tank
{
   ...
   public class TankBody2
   {
      ...
      public function toDie() : *
      {
         ...
         Game.oneScene.shake.startShake(5,0.5,Math.random() * 10,-5,5,0,"cos");
      }

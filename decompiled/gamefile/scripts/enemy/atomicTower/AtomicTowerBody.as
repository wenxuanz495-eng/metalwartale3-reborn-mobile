package enemy.atomicTower
{
   ...
   public class AtomicTowerBody
   {
      ...
      public var AAHD:AtomicTowerAAHD;
      
      public var attack:ArmsAttack;
      
      public var ai:AtomicTower_AI;
      ...
      public function AtomicTowerBody()
      {
         super();
         this.AAHD = new AtomicTowerAAHD(this,this.img,this.armsDefine,this.define);
         this.ai = new AtomicTower_AI(this);
      ...
      {
         var rect0:Rectangle = this.define.hurtRectArr[0];

package enemy.darkTemplar
{
   ...
   import enemy.electricSaw.ElectricSawAAHD;
   import enemy.striker.StrikerAnimation;
   import flash.geom.Rectangle;
   import image.ShakeMotion;
   
   public class DarkTemplarBody
   {
      ...
      public var animation:StrikerAnimation;
      
      public var AAHD:ElectricSawAAHD;
      
      public var ai:DarkTemplar_AI;
      ...
      public function DarkTemplarBody()
      {
         super();
         this.animation = new StrikerAnimation(this.img,this.mot);
         this.AAHD = new ElectricSawAAHD(this,this.define,this.img);
         this.ai = new DarkTemplar_AI(this);
      }

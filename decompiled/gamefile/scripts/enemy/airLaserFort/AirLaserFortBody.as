package enemy.airLaserFort
{
   ...
   public class AirLaserFortBody
   {
      ...
      public var AAHD:AirLaserFortAAHD;
      
      public var ai:AirLaserFort_AI;
      ...
      public function AirLaserFortBody()
      {
         super();
         this.AAHD = new AirLaserFortAAHD(this,this.img,this.armsDefine,this.define);
         this.attack = new ArmsAttack(this,this.AAHD,this.armsDefine);
         this.ai = new AirLaserFort_AI(this);
      }

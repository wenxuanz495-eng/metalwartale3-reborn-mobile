package UI.explore
{
   ...
   public class ExploreIconBox extends Sprite
   {
      ...
      public function ExploreIconBox(_type:String = "arms", _siteRankB:Boolean = false)
      {
         super();
         this.type = _type;
      ...
      public function inData_byArr(arr0:Array, _fastB:Boolean = false, _numB:Boolean = true) : *
      {
         var n:* = undefined;
         var d0:* = undefined;
         this.clear();
         ...
         {
            d0 = arr0[n];
            this.arr[n].fastB = _fastB;
            this.arr[n].numB = _numB;

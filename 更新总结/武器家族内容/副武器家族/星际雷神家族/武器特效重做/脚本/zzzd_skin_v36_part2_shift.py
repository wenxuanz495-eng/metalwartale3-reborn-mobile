# -*- coding: utf-8 -*-
# 星际雷神 V36 修订（2026-09-18，仅 lv1；部件2 整体微调——用户 directive）：
...
SRC_XML  = "work"+BS+"sub1130-v36-src.xml"
OUT_XML  = "work"+BS+"sub1130-v36.xml"
OUT_SWF  = "work"+BS+"sub1130-v36.swf"
RB_XML   = "work"+BS+"sub1130-v36-readback.xml"
...
assert actual == manifest_line.upper() and actual.startswith("5BA8B6FD"), actual[:8]
...
for it in sp121.find('subTags'):
    ...
    if cid == '2931' and d == '1':
        m = it.find('matrix')
        assert m.get('translateX') == '1800' and m.get('translateY') == '300'
        m.set('translateX', '1700')
        m.set('translateY', '360')
        expect['2931'] = ('1', '1700', '360')
    if cid == '2933' and d == '2':
        m = it.find('matrix')
        assert m.get('translateX') == '1800' and m.get('translateY') == '660'
        m.set('translateX', '1700')
        m.set('translateY', '720')
        expect['2933'] = ('2', '1700', '720')
assert len(expect) == 2, "部件2 放置未找齐"
print("矩阵修改 PASS：2931→(1700,360)、2933→(1700,720)（左5/下3）")
